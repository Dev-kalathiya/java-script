...
const objectMapper = (data) => {
    ...
    data.map((ele) => {
        ...
        category.setAttribute("class", "btn1 ")

        let AddToCart = document.createElement("button")
        AddToCart.innerHTML = "Add To Cart"
        AddToCart.setAttribute("class", "btn1 ")
        let div = document.createElement("div")
        div.setAttribute("class", "col-4")
        div.append(img, title, price, category, AddToCart)
        ...
        // events
        AddToCart.addEventListener("click", () => handleCart(ele))
